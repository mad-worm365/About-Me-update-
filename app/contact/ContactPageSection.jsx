...
// Dynamically import Three.js components with ssr: false to prevent server-side rendering
const ThreeJSCanvas = dynamic(() => import('./ThreeJSCanvas'), { ssr: false });
