    ...
    const testimonials = [
        {
            ...
            text: "Led delivery on Kohler.com visual commerce — 3D configuration, finish visualization, and scalable platform work that made our AI and e-commerce features reliable at enterprise scale."
        },
        {
            name: "Emily Chen",
        ...
        },
        {
            ...
            text: "A full-stack leader on AI and platform work for US enterprise brands—from Kohler visual experiences to Kafka pipelines and Kubernetes in production."
        },
    ];
